...
/**
 * Created by SNEHA DIDIGAM on 2/22/2017.
 */
...

{
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("CameraMap Page") // TODO: Define a title for the content shown.
                // TODO: Make sure this auto-generated URL is correct.
                .setUrl(Uri.parse("https://www.google.com/maps"))
                .build();
    ...
    public void onStart() {
        ...
        // See https://g.co/AppIndexing/AndroidStudio for more information.
        google_ApiClient.connect();
        AppIndex.AppIndexApi.start(google_ApiClient, getIndexApiAction());
    }
    ...
    public void onStop() {
        ...
        // ATTENTION: This was auto-generated to implement the App Indexing API.
        // See https://g.co/AppIndexing/AndroidStudio for more information.
        AppIndex.AppIndexApi.end(google_ApiClient, getIndexApiAction());
        google_ApiClient.disconnect();
    }
}